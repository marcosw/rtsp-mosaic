...
setup ch4 input $STREAM04
setup ch4 output #mosaic-bridge{id=ch4,width=640,height=540}
...
setup bg option image-fps=30
setup bg option mosaic-width=1920
setup bg option mosaic-height=1080
setup bg option mosaic-keep-picture=1	

setup bg output #transcode{vcodec=mp4v,vb=0,fps=0,acodec=none,channels=4,sfilter=mosaic{alpha=255,width=1280,height=1080,cols=2,rows=2,position=1,order="ch1,ch2,ch3,ch4",keep-aspect-ratio=enabled,mosaic-align=0,keep-picture=1}}:bridge-in{offset=100}:display
